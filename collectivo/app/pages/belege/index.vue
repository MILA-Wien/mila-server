...
<template>
  <div class="p-6 space-y-4">
    ...
    <!-- <UCard v-for="(ind, beleg) in belege" :key="ind" class="p-3">
      {{ beleg }}
      <div class="flex justify-between">
        <span>{{ beleg.datum }}</span>
        <span class="font-medium">{{ beleg.betrag.toFixed(2) }} €</span>
      </div>
      <div class="text-sm text-gray-500">{{ beleg.beschreibung }}</div> 
    </UCard> -->
