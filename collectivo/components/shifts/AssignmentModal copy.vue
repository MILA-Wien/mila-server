...
function loadAssignments() {
  directus
    ...
    .catch((error) => showToast("Failed to load assignments", error, "error"));
}
...
async function onCreate() {
  if (!user.value.data) {
    showToast("User data not loaded", null, "error");
    return;
  }
  ...
  directus
    ...
    .catch((error) => showToast("Failed to create assignment", error, "error"))
    .finally(() => {
      loading.value = false;
      isOpen.value = false;
      reset();
...
async function onUpdate() {
  ...
  directus
    ...
    .catch((error) => showToast("Failed to update assignment", error, "error"))
    .finally(() => {
      loading.value = false;
      isOpen.value = false;
      reset();
